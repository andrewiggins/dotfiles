...
| **AI agents** | Claude Code, Codex, Pi Coding Agent | `command -v claude && command -v codex && command -v pi` |
...
- **Check**: starship (installed to `~/.local/bin`), `claude`, `codex`, `pi`, volta, node, pnpm
